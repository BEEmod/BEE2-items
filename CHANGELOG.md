...
* New design for visible Logic Gates:
	* The design matches checkmark/cross signage.
	* If only a single input is connected, they visually convert to a NOT gate.
	* Old Aperture has its own design matching that theme.
